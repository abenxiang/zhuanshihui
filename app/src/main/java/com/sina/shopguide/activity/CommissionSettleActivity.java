...
import com.sina.shopguide.net.requestinterface.ICommisionListRequest;
...
public class CommissionSettleActivity extends BaseActivity {

    private PullToRefreshListView prflView;
    private ImageView ivHis;

    private List<WithDrawItem> lstWithDraw = new ArrayList<WithDrawItem>();
    private WithdrawListAdapter withdrawListAdapter = null;
    private Income income;
    private int page = 1;
    public void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_commission_settle);

        ivHis = (ImageView)findViewById(R.id.title_right_opr);
        prflView = (PullToRefreshListView)findViewById(R.id.id_list_view);

        ivHis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(CommissionSettleActivity.this, WithDrawDetailActivity.class);
                startActivity(in);
            }
        });
    ...
    private void getList() {
        ...
        ICommisionListRequest request = retrofit.create(ICommisionListRequest.class);
        ...
        call.enqueue(new Callback<ListApiResult<WithDrawItem>>() {
            ...
            public void onResponse(Call<ListApiResult<WithDrawItem>> call, Response<ListApiResult<WithDrawItem>> response) {
                ...
                List<WithDrawItem> result = response.body().getData();
    ...
    private class WithdrawListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(v == null) {
                v = new WithDrawItemView(CommissionSettleActivity.this);
            }
