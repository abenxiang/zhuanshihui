...
public class MultiTouchUtils {
	...
	public static boolean isSupportMultiTouch(Context context) {
		if (mIsSupportMultiTouch == null) {
			...
			try {
				mIsSupportMultiTouch = (Boolean) ReflectionUtils.invokeMethod(pm,
						methodName, new Object[] { featureName });
			} catch (Exception e) {
				e.printStackTrace();
	...
	public static class MotionEventUtils {
		...
		static {
			try {
				ACTION_POINTER_DOWN = (Integer) ReflectionUtils.getStaticProperty(
						MotionEvent.class.getName(), TAG_ACTION_POINTER_DOWN);
				ACTION_POINTER_UP = (Integer) ReflectionUtils.getStaticProperty(
						MotionEvent.class.getName(), TAG_ACTION_POINTER_UP);
				ACTION_MASK = (Integer) ReflectionUtils.getStaticProperty(
		...
		public static float getX(MotionEvent event, int pointerIndex) {
			Object ret = ReflectionUtils.invokeMethod(event, TAG_GET_X,
					new Class[] { int.class }, new Object[] { pointerIndex });
			if (ret != null) {
				return (Float) ret;
			}
		...
		public static float getY(MotionEvent event, int pointerIndex) {
			Object ret = (Float) ReflectionUtils.invokeMethod(event, TAG_GET_Y,
					new Class[] { int.class }, new Object[] { pointerIndex });
			if (ret != null) {
				return (Float) ret;
			}
