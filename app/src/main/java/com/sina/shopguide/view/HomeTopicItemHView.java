...
public class HomeTopicItemHView extends RelativeLayout  implements
								IUpdateWithPositon<zhuanti>{
	...
	@Override
	public void update(zhuanti data, int position) {
	...
	public HomeTopicItemHView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public HomeTopicItemHView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public HomeTopicItemHView(Context context) {
		super(context);
		init();
	}

	private void init() {
		inflate(getContext(), R.layout.vw_home_topic_h_item, this);
