...
public class HorizTextEditView extends RelativeLayout {
    ...
    public HorizTextEditView(Context context, AttributeSet attrs,
                             int defStyle) {
    ...
    public HorizTextEditView(Context context) {
        super(context);
        init(null);
    }

    private void init(AttributeSet attrs) {
        inflate(getContext(), R.layout.vw_horiz_textedit, this);
